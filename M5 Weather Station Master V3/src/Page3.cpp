...
void Get_Page3(){
 ...
 // Return a string containing the HTML code of the page
  ...
  webpage +=(Board_3PV.Temperature);
  webpage +=F("<td>");
  webpage +=(Board_3LOW.Temperature);
  webpage +=F("<td>");
  webpage +=(Board_3HIGH.Temperature);
  webpage +=F("</td></td>");
  webpage +=F("<tr><td>DHT22</td><td>Humidity</td><td>"); // 2nd line : humidity *************************<tr class='active'>
  webpage +=(Board_3.Humidity);
  webpage +=F("%</td><td>");
  webpage +=(Board_3PV.Humidity);
  webpage +=F("<td>");
  webpage +=(Board_3LOW.Humidity);
  webpage +=F("<td>");
  webpage +=(Board_3HIGH.Humidity);
  SendHTML_Content();
  ...
  webpage +=(Board_3.BMP_Temperature);
  webpage +=F("&deg;C</td><td>");
  webpage +=(Board_3PV.BMP_Temperature);
  webpage +=F("<td>");
  webpage +=(Board_3LOW.BMP_Temperature);
  webpage +=F("<td>");
  webpage +=(Board_3HIGH.BMP_Temperature);
  ...
  webpage +=(Board_3PV.BMP_Pressure);
  webpage +=F("<td>");
  webpage +=(Board_3LOW.BMP_Pressure);
  webpage += F("<td>");
  webpage +=(Board_3HIGH.BMP_Pressure);
  ...
  webpage +=(Board_3.Light);
  webpage +=F("%<td>"); 
  webpage +=(Board_3PV.Light);
  webpage +=F(" %<td>");
  webpage +=(Board_3LOW.Light);
  webpage +=F(" %<td>");
  webpage +=(Board_3HIGH.Light);
