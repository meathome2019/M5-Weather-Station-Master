...
void Get_Page7(){
 ...
 // Return a string containing the HTML code of the page
  ...
  webpage +=(Board_7PV.Temperature);
  webpage +=F("<td>");
  webpage +=(Board_7LOW.Temperature);
  webpage +=F("<td>");
  webpage +=(Board_7HIGH.Temperature);
  webpage +=F("</td></td>");
  webpage +=F("<tr><td>DHT22</td><td>Humidity</td><td>"); // 2nd line : humidity *************************<tr class='active'>
  webpage +=(Board_7.Humidity);
  webpage +=F("%</td><td>");
  webpage +=(Board_7PV.Humidity);
  webpage +=F("<td>");
  webpage +=(Board_7LOW.Humidity);
  webpage +=F("<td>");
  webpage +=(Board_7HIGH.Humidity);
  SendHTML_Content();
  ...
  webpage +=(Board_7.BMP_Temperature);
  webpage +=F("&deg;C</td><td>");
  webpage +=(Board_7PV.BMP_Temperature);
  webpage +=F("<td>");
  webpage +=(Board_7LOW.BMP_Temperature);
  webpage +=F("<td>");
  webpage +=(Board_7HIGH.BMP_Temperature);
  ...
  webpage +=(Board_7PV.BMP_Pressure);
  webpage +=F("<td>");
  webpage +=(Board_7LOW.BMP_Pressure);
  webpage +=F("<td>");
  webpage +=(Board_7HIGH.BMP_Pressure);
  ...
  webpage +=(Board_7.Light);
  webpage +=F("%<td>"); 
  webpage +=(Board_7PV.Light);
  webpage +=F(" %<td>");
  webpage +=(Board_7LOW.Light);
  webpage +=F(" %<td>");
  webpage +=(Board_7HIGH.Light);
