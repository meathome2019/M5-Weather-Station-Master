...
void Get_Page4(){
 ...
 // Return a string containing the HTML code of the page
  ...
  webpage +=(Board_4PV.Temperature);
  webpage +=F("<td>");
  webpage +=(Board_4LOW.Temperature);
  webpage +=F("<td>");
  webpage +=(Board_4HIGH.Temperature);
  webpage +=F("</td></td>");
  webpage +=F("<tr><td>DHT22</td><td>Humidity</td><td>"); // 2nd line : humidity *************************<tr class='active'>
  webpage +=(Board_4.Humidity);
  webpage +=F("%</td><td>");
  webpage +=(Board_4PV.Humidity);
  webpage +=F("<td>");
  webpage +=(Board_4LOW.Humidity);
  webpage +=F("<td>");
  webpage +=(Board_4HIGH.Humidity);
  SendHTML_Content();
  ...
  webpage +=(Board_4.BMP_Temperature);
  webpage +=F("&deg;C</td><td>");
  webpage +=(Board_4PV.BMP_Temperature);
  webpage +=F("<td>");
  webpage +=(Board_4LOW.BMP_Temperature);
  webpage +=F("<td>");
  webpage +=(Board_4HIGH.BMP_Temperature);
  ...
  webpage +=(Board_4PV.BMP_Pressure);
  webpage +=F("<td>");
  webpage +=(Board_4LOW.BMP_Pressure);
  webpage += F("<td>");
  webpage +=(Board_4HIGH.BMP_Pressure);
  ...
  webpage +=(Board_4.Light);
  webpage +=F("%<td>"); 
  webpage +=(Board_4PV.Light);
  webpage +=F(" %<td>");
  webpage +=(Board_4LOW.Light);
  webpage +=F(" %<td>");
  webpage +=(Board_4HIGH.Light);
